...
public class MainActivity extends Activity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (intent.getAction().equals("org.post.aguaclara.postdose.COLLECT"))  {
            ...
            //TODO: this still crashes if s is "" / empty
            try {
...
//        client = new GoogleApiClient.Builder(this).addApi(AppIndex.API).build();
    ...
    private class MakeRequestTask extends AsyncTask<Void, Void, List<String>> {
        ...
        /**
         * Fetch a list of params and values, linear models only for now
         * https://docs.google.com/spreadsheets/d/1BxiMVs0XRA5nFMdKvBdBZjgmUUqptlbs74OgvE2upms/edit
         * @return List of names and majors
         * @throws IOException
         */
        private List<String> getDataFromApi() throws IOException {
                //TODO: Move this definition to somewhere global
            String spreadsheetId = "1NFuGrusRcQa6WCnM9-QiJvm_Bgg4DHyuxXPGdsapBCg";
            ...
            if (values != null) {
                ...
                for (List row : values) {
                    ...
                    try {
                        j.put(row.get(0).toString(),row.get(1).toString());
                    } catch (JSONException e) {
                        System.err.println("JSON-ifying the response failed");
                        e.printStackTrace();
                    }
                }
...
//                mProgress.show();
//            } catch (Exception e){
//                System.out.println("WARN: Error caught trying to draw on the canvas.");
//            }
        }
